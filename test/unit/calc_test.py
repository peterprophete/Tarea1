...
class TestCalculate(unittest.TestCase):
  ...
  def test_divide_method_fails_with_non_numeric_zero(self):
    self.assertRaises(TypeError, self.calc.divide, 2, "0")  # División por cadena
    self.assertRaises(TypeError, self.calc.divide, 2, None)  # División por None
